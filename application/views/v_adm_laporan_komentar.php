...
<?php echo $this->session->flashdata('msg');?>
  <div id="page-wrapper">
     <div class="container-fluid">
         ...
         <div class="row">
                 <h3 class="">
                     <a href="<?php echo base_url('adm_lapor');?>"><small> Laporan Review</small></a>
                     Laporan Komentar
                 </h3>
                 <hr>
                ...
                <tbody>
                  ...
                  <?php foreach ($record as $row) : ?>
                    <tr>
                      ...
                      <td width='45%'><?php echo $row['isi_komentar']; ?></td>
                              ...
                              <div class="form-group">
                                <label for=""> Isi Konten : </label> <br/>
                                  ...
                                  <a href="<?php echo base_url('adm_lapor/hapus_laporan/'.$row['lapor_ID']);?>" onclick="return confirm('Anda yakin ingin menghapus data ini ?')"
                                    class="btn btn-xs btn-danger" title="Hapus Laporan"><i class="glyphicon glyphicon-remove"></i>Hapus Laporan</a>
                          </div>
                          <!-- footer modal -->
