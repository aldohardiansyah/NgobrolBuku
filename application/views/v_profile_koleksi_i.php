            ...
            <?php foreach ($record_6 as $row) : ?>
                <div class="col-xs-6 col-md-3">
                  <div class="thumbnail">
                      ...
                      <a class="btn btn-xs btn-danger" href="<?php echo base_url('profile/hapus_buku_ibaca/'.$row['buku_ID']);?>" onclick="return confirm('Tambahkan ke daftar buku yang sedang anda baca ?')"><i class="glyphicon glyphicon-trash"></i></a></center>
                    </div>
                  </div>
                </div>
          <?php endforeach; ?>
